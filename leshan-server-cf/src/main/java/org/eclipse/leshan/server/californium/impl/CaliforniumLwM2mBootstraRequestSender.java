...
public class CaliforniumLwM2mBootstraRequestSender implements LwM2mBootstrapRequestSender {
    static final Logger LOG = LoggerFactory.getLogger(CaliforniumLwM2mBootstraRequestSender.class);

    private final Endpoint nonSecureEndpoint;
    private final Endpoint secureEndpoint;
    private final LwM2mModel model;

    public CaliforniumLwM2mBootstraRequestSender(final Endpoint secureEndpoint, final Endpoint nonSecureEndpoint,
